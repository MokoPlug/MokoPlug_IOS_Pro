...
@interface MKBPMUpdateController ()<UITableViewDelegate,UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKBPMDFUModule *dfuModule;
...
@implementation MKBPMUpdateController

- (void)dealloc {
    NSLog(@"MKBPMUpdateController销毁");
...
- (void)updateComplete {
    ...
    [MKBPMCentralManager sharedDealloc];
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_bpm_centralDeallocNotification" object:nil];
...
- (MKBPMDFUModule *)dfuModule {
    if (!_dfuModule) {
        _dfuModule = [[MKBPMDFUModule alloc] init];
    }
    return _dfuModule;
}
