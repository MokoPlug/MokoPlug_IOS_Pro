...
@interface MKBPMDFUModule()<LoggerDelegate, DFUServiceDelegate, DFUProgressDelegate>
...
@implementation MKBPMDFUModule

- (void)dealloc{
    NSLog(@"MKBPMDFUModule销毁");
}
...
- (void)updateWithFileUrl:(NSString *)url
    ...
    self.dfuController = [initiator startWithTarget:[MKBPMCentralManager shared].peripheral];
}
