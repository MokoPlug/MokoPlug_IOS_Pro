...
@interface MKBPMDeviceInfoModel ()
...
@implementation MKBPMDeviceInfoModel
...
- (BOOL)readMacAddress {
    ...
    [MKBPMInterface bpm_readMacAddressWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readDeviceModel {
    __block BOOL success = NO;
    [MKBPMInterface bpm_readDeviceModelWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readSoftware {
    __block BOOL success = NO;
    [MKBPMInterface bpm_readSoftwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readFirmware {
    __block BOOL success = NO;
    [MKBPMInterface bpm_readFirmwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readHardware {
    __block BOOL success = NO;
    [MKBPMInterface bpm_readHardwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readManu {
    __block BOOL success = NO;
    [MKBPMInterface bpm_readManufacturerWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
