...
@implementation MKBPMCountdownPickerViewModel
@end

@interface MKBPMCountdownPickerView()<UIPickerViewDataSource, UIPickerViewDelegate>
...
@property (nonatomic, copy)void (^timePickerBlock)(MKBPMCountdownPickerViewModel *timeModel);
...
@implementation MKBPMCountdownPickerView

- (void)dealloc{
    NSLog(@"MKBPMCountdownPickerView销毁");
}
